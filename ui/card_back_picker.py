...
class CardBackPickerDialog(ctk.CTkToplevel):
    ...
    def _build(self):
        ...
        ctk.CTkButton(self, text="Cancel", fg_color="gray30", hover_color="gray20",
    ...
    def _build_upload_tab(self, parent):
        ...
        ctk.CTkButton(parent, text="Use this image", fg_color="#1f6aa5",
    ...
    def _add_gallery_placeholder(self, parent, path: str) -> tk.Label:
        card = ctk.CTkFrame(parent, fg_color="gray20", corner_radius=6)
        card.pack(side="left", padx=6)

        lbl = tk.Label(card, image=self._placeholder_ref, bg="#2b2b2b", cursor="hand2")
        ...
        ctk.CTkLabel(card, text=name, font=ctk.CTkFont(size=10),
                     text_color="gray70").pack(padx=4, pady=(0, 6))
